...
Ces activités sont certes obligatoires,  aucun utilisateur ne va par exemple payer une fonctionnalité si l'application n'est pas déployée pour qu'il l'utilise. Par contre, l'utilisateur ne paye pas pour une installation,il paye une fonctionnalité.
